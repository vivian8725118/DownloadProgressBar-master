...
public class DownloadProgressBar extends View {
    ...
    private final float mTextSize=20;//sp
    ...
    private void init() {
        ...
        mProgressNumberPaint=new Paint();
        mProgressNumberPaint.setFlags(Paint.ANTI_ALIAS_FLAG);
        mProgressNumberPaint.setColor(mProgressColor);
        mProgressNumberPaint.setStyle(Paint.Style.FILL);
    ...
    private void drawing(Canvas canvas) {
        ...
        switch (mState) {
            ...
            case ANIMATING_MANUAL_PROGRESS:
                ...
                float txtSize=sp2px(getContext(),mTextSize);
                mProgressNumberPaint.setTextSize(txtSize);
                float lenText=mProgressNumberPaint.measureText(mProgress+"%");
                Paint.FontMetrics fontMetrics = mProgressNumberPaint.getFontMetrics();
                float heightText=fontMetrics.bottom-fontMetrics.top;
                canvas.drawText(mProgress+"%",mCenterX-lenText/2,mCenterY+heightText/3,mProgressNumberPaint);
